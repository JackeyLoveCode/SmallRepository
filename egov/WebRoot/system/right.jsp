...
<script type="text/javascript">
	...
	function changeImag(){
		...
		//一个也没选中
		if(checkboxCount==0){
			userDeleteObg.src="/egov/images/user_delete_disabled.png"; 
			userUpdateObg.src="/egov/images/user_edit_disabled.png";
		...
		if(checkboxCount==1)
		{
			...
			userDeleteObg.src="/egov/images/user_delete.png"; 
			userUpdateObg.src="/egov/images/user_edit.png";
	...
	function goDelete(){
		if(window.confirm("您确定要删除吗？")){
			document.forms["userForm"].action = "/egov/servlet/deleteUser";
			document.forms["userForm"].submit();
		}
...
<body onload="changeImag()">
	...
	<%
	 ...
	 %>
	 <form action="/egov/servlet/goUpdate" method="POST" name="userForm">
	 <input type="hidden" name="pageno" value="<%=pageno%>"/>
	 <table align="left" bgcolor="gray"   width="1000px" height="200px">
	 	<tr>
	 	<td  align="right"><img  src="/egov/images/user_add.png" id ="user_add" style="cursor:pointer" 
	 	onclick="javascript:window.location.href='/egov/user/addUser.jsp'"/></td>
	 	<td  align="right"><img  src="/egov/images/user_delete_disabled.png" id="user_delete" style="cursor:pointer"
	 	onclick="goDelete()"/></td>
	 	<td  align="right"><img  src="/egov/images/user_edit_disabled.png" id="user_edit" style="cursor:pointer"
	 	onclick="goUpdate()"/></td>
	 	</tr>
	 	<tr>
